      ...
      <AnimatePresence>
        {clients.map((client, index) =>
          index === currentIndex ? (
            ...
            >
              <h1 className='text-4xl font-semibold mb-4 text-white'>Best Trusted Cyber Security</h1>
              <motion.img
                src={Stare}
                className='h-12 mb-4'
                alt="Star Icon"
                ...
                transition={{ duration: 0.5 }}
              />
              <p className="text-xl mb-4 text-white max-w-screen-md line-clamp-4 flex"><span className='text-5xl pr-4 '>"</span>{client.testimonial} <span className='text-5xl pl-4 pt-4'>"</span></p>
